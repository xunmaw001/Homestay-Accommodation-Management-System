 ...
 */
@RestController
@RequestMapping("/minsufenlei")
public class MinsufenleiController {
    @Autowired
    private MinsufenleiService minsufenleiService;
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,MinsufenleiEntity minsufenlei, 
		HttpServletRequest request){

        EntityWrapper<MinsufenleiEntity> ew = new EntityWrapper<MinsufenleiEntity>();
    	PageUtils page = minsufenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, minsufenlei), params), params));
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,MinsufenleiEntity minsufenlei, HttpServletRequest request){
        EntityWrapper<MinsufenleiEntity> ew = new EntityWrapper<MinsufenleiEntity>();
    	PageUtils page = minsufenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, minsufenlei), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
    ...
    public R update(@RequestBody MinsufenleiEntity minsufenlei, HttpServletRequest request){
        //ValidatorUtils.validateEntity(minsufenlei);
        minsufenleiService.updateById(minsufenlei);//全部更新
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        minsufenleiService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<MinsufenleiEntity> wrapper = new EntityWrapper<MinsufenleiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = minsufenleiService.selectCount(wrapper);
