...
public class DiscusskefangxinxiController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscusskefangxinxiEntity discusskefangxinxi, HttpServletRequest request){
        EntityWrapper<DiscusskefangxinxiEntity> ew = new EntityWrapper<DiscusskefangxinxiEntity>();
    	PageUtils page = discusskefangxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discusskefangxinxi), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscusskefangxinxiEntity> wrapper = new EntityWrapper<DiscusskefangxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discusskefangxinxiService.selectCount(wrapper);
